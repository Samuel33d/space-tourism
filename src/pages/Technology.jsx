      ...
      <section className="grid gap-3 sm:w-full transition-all mt-10 lg:grid-cols-[auto,1fr] lg:grid-rows-[auto,1fr]">
        ...
        {pageShow === 2 && (
          <TechnologyLayout
            ...
            imgPortrait={
              "/public/assets/technology/image-spaceport-portrait.jpg"
            }
            imgLandscape={
              "/public/assets/technology/image-spaceport-landscape.jpg"
            }
            setPageShow={setPageShow}
            pageShow={pageShow}
          />
        ...
        {pageShow === 3 && (
          <TechnologyLayout
            ...
            imgPortrait={
              "/public/assets/technology/image-space-capsule-portrait.jpg"
            }
            imgLandscape={
              "/public/assets/technology/image-space-capsule-landscape.jpg"
            }
            setPageShow={setPageShow}
            pageShow={pageShow}
          />
