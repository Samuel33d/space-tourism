...
const Home = () => {
  return (
    <>
      ...
      <main className="animate__animated animate__fadeIn grid place-items-center  h-screen bg-[url('/assets/home/background-home-mobile.jpg')] bg-bottom bg-no-repeat bg-cover sm:bg-center sm:bg-[url('/assets/home/background-home-tablet.jpg')] md:bg-[url('/assets/home/background-home-desktop.jpg')] transition-all duration-500 ">
